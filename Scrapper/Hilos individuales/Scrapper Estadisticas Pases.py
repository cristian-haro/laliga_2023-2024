...
try:
    ...
    ## passing
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'passing')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Pases.xlsx")
