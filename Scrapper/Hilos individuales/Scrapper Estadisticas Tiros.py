...
try:
    ...
    ## shooting
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'shooting')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Tiros.xlsx")
