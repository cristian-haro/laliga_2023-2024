# Scrapper Estadisticas Posesion
...
try:
    ...
    ## possession
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'possession')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Posesion.xlsx")
