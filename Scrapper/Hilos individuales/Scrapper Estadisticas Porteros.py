# Scrapper Estadisticas Porteros
...
try:
    ...
    ## Porteros
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'goalkeeping')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Porteros.xlsx")
