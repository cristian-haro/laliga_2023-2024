# Scrapper Estadisticas Diversas
...
try:
    ## misc
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'misc')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Diversas.xlsx")
