# Scrapper Estadisticas Tiempo de Juego
...
try:
    ...
    ## playing time
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'playing time')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Tiempo de juego.xlsx")
