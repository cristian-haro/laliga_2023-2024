# Scrapper Estadisticas Porteros Avanzado
...
try:
    ...
    ## advanced goalkeeping
        ...
        lg_table = scraper.scrape_stats("2023-2024", 'La Liga', 'advanced goalkeeping')
        ...
        output_path = os.path.join(output_dir, "Estadisticas Jugadores Porteros Avanzado.xlsx")
